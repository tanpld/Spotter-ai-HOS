...
interface LocationInputProps {
  ...
  value: string;
  placeholder: string;
  /** Called on every keystroke (no coords = user typed manually, coords = user picked suggestion) */
...
export default function LocationInput({
  ...
  const fetchSuggestions = useCallback(async (q: string) => {
    ...
    // Abort any in-flight request to avoid stale results arriving out of order

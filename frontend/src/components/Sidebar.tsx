      ...
      <div className="rounded-2xl border border-slate-700 bg-slate-800/60 backdrop-blur p-6 shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor="current_cycle_used" className="text-xs font-semibold text-slate-400 uppercase tracking-wide">
              Current Cycle Used
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                onChange={e => onChange('current_cycle_used', parseFloat(e.target.value) || 0)}
                placeholder="0"
                required
              ...
              <div className="shrink-0 w-20">
                ...
                <div className="h-1.5 rounded-full bg-slate-700 overflow-hidden">
                  <div
                    ...
                    style={{ width: `${Math.min(((values.current_cycle_used ?? 0) / 70) * 100, 100)}%` }}
                  />
                </div>
              </div>
            </div>
